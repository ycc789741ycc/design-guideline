...
| Folder | Scope |
|---|---|
| [`shared/`](shared) | Cross-cutting rules that apply regardless of role: naming, error handling, logging, configuration, security baseline, testing philosophy. Read this first. |
