...
| Folder | Scope |
|---|---|
| [`shared/`](shared) | Cross-cutting rules that apply regardless of role: naming, error handling, logging, configuration, build/run/test entrypoints, security baseline, testing philosophy, version control, decision records. Read this first. |
